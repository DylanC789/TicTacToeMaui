...
namespace TicTacToeMaui
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            // Fades the title out over 1 second (1000 milliseconds)
            await XMasTitle.FadeTo(0, 2000);

            // Fades the title back in over 1 second
            await XMasTitle.FadeTo(1, 2000);
        }
        private void AnimateStatusLabel()
        {
            ...
            parentAnimation.Commit(this, "TextColorAnimation", length: 3000, repeat: () => true);
        }
        private void OnButtonClicked(object sender, EventArgs e)
        {
            ...
            if (_player == null)
            {
                ...
                var audioFile = await FileSystem.OpenAppPackageFileAsync("notificationpluck.mp3");
